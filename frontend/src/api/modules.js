...
export const intelApi={ip:(ip)=>api.get(`/intel/ip/${encodeURIComponent(ip)}`),domain:(d)=>api.get(`/intel/domain/${encodeURIComponent(d)}`),url:(u)=>api.get(`/intel/url/${encodeURIComponent(u)}`)};
