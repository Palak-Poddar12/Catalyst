...
<Route path="/map" element={<Protected permission="map:view"><ThreatMap/></Protected>}/><Route path="/cases/:caseId" element={<Protected permission="case:view"><CaseDetail/></Protected>}/><Route path="/intelligence" element={<Protected permission="threatintel:view"><Intelligence/></Protected>}/><Route path="/reports" element={<Protected permission="report:view"><Reports/></Protected>}/><Route path="/gmail" element={<Protected permission="gmail:investigate"><Gmail/></Protected>}/><Route path="/admin/*" element={<Protected permission="users:manage"><Admin/></Protected>}/><Route path="/profile" element={<Protected><Profile/></Protected>}/><Route path="*" element={<Navigate to="/dashboard" replace/>}/></Routes>}
